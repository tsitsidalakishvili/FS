...
BLOCKED_PREFIXES = (".git/", "agent_chain/runs/", "AIteam/agent_chain/runs/")
...
def apply_operations(*, repo_root: str | Path, operations: list[dict[str, Any]], dry_run: bool = False) -> ApplyReport:
