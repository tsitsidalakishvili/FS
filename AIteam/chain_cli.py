...
def build_parser() -> argparse.ArgumentParser:
    ...
    sp = sub.add_parser("message", help="Send a message to an agent")
    sp.add_argument("--run-id", required=True)
    ...
    sp.add_argument("--executor", action="store_true", help="Enable Executor (auto-implement) phase")
    sp.add_argument("--apply-to-repo", action="store_true", help="Actually apply Executor changes to repo")
    sp.add_argument("--print-state", action="store_true", help="Print full state.json to stdout")
